...
export default async function LeadsPage({ searchParams }: LeadsPageProps) {
  try {
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-red-200 p-8 flex flex-col items-center justify-center text-center">
            <p className="text-red-600 font-medium mb-4">
              {result?.error || 'Erro desconhecido. Tente recarregar a página.'}
            </p>
    ...
    // Erro genérico - algo inesperado aconteceu
    console.error('LeadsPage: Erro não tratado:', error);
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-red-200 p-8 flex flex-col items-center justify-center text-center">
          <p className="text-red-600 font-medium mb-4">
            Ops! Algo deu errado ao carregar a página de leads.
          </p>
